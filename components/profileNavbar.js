            ...
            <div class="col-md-6">
                <div class="card mb-4 mb-md-0">
                    <div class="card-body">
                        ...
                        <p class="mt-4 mb-1" style="font-size: .77rem;">Yogesh Kumar Kumawat : <i class="fab fa-github fa-lg" style="color: #333333;"></i> <a href="https://github.com/Yogesh358"> Yogesh358</a></p>
                        <div class="progress rounded" style="height: 5px;">
                            <div class="progress-bar" role="progressbar" style="width: 72%" aria-valuenow="72" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
